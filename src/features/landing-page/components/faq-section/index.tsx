...
export const FAQSection = () => {
  const faqs = [
    {
      question: "Is SubscriptEase really a one-time payment?",
      answer:
    ...
    {
      question: "How does SubscriptEase remind me about upcoming payments?",
      answer:
        "SubscriptEase sends you email notifications before your subscriptions renew. You can customize when you want to be notified (e.g., 3 days before, 1 week before).",
    },
    {
      question: "Can I track both monthly and annual subscriptions?",
      answer:
        "Absolutely! SubscriptEase supports all billing cycles including monthly, quarterly, annual, and even custom periods.",
    },
    {
    ...
    {
      question: "Can I use SubscriptEase on my mobile device?",
      answer:
        "Yes, SubscriptEase is fully responsive and works great on mobile devices, tablets, and desktops.",
    },
    {
