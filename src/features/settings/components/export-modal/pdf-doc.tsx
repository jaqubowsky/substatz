...
export const SubscriptionPdfDocument = ({ subscriptions }: { subscriptions: Subscription[] }) => (
    <Document>
      <Page size="A4" style={styles.page} orientation="landscape">
        ...
        <View style={styles.table}>
          <View style={[styles.tableRow, styles.tableHeader]}>
            ...
            <Text style={[styles.tableCell, styles.mediumCell]}>Billing Cycle</Text>
          ...
          {subscriptions.map((sub) => (
            <View style={styles.tableRow} key={sub.id}>
              ...
              <Text style={[styles.tableCell, styles.priceCell]}>{sub.price.toFixed(2)}</Text>
              <Text style={[styles.tableCell, styles.smallCell]}>{sub.currency}</Text>
              <Text style={[styles.tableCell, styles.mediumCell]}>{sub.category}</Text>
              <Text style={[styles.tableCell, styles.mediumCell]}>{sub.billingCycle}</Text>
